...
namespace CLIESC_EUREKABANK.Vista
{
    ...
    {
        private List<Telefono> _cartTelefonos;
        ...
        public CarritoView(List<Telefono> cartTelefonos)
        {
            InitializeComponent();
        ...
        private Border CreateTarjetaTelefono(Telefono telefono)
        {
        ...
        private Grid CreateTarjetaGrid(Telefono telefono)
        {
        ...
        private StackPanel CreateDetailsPanel(Telefono telefono)
        {
        ...
        private Button CreateDeleteButton(Telefono telefono)
        {
        ...
        {
            if (_total > 0 && cantidad >0)
            {
                creditoView = new pagarCreditoView(_total,cantidad);
                creditoView.Show();
            }
            else
            {
        ...
        private void pagarEfectivo_Click(object sender, RoutedEventArgs e)
        {
            if (_total > 0 && cantidad > 0)
            {
                _pagination = new PagarEfectivoView(_total,cantidad);
                _pagination.Show();
            }
            else
            {
