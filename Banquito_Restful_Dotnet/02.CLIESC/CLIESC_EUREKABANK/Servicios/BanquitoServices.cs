...
namespace CLIESC_EUREKABANK.Servicios
{
    class BanquitoServices
    {
        ...
        public async Task<bool> CrearFactura(int codCliente, decimal total, string formaPago)
        {
            try
            {
                ...
                string url = $"{urlIp}/factura/crear?codCliente={codCliente}&total={formattedTotal}&formaPago={formaPago}";
