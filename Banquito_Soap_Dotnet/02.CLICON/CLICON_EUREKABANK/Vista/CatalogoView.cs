    ...
    public class CatalogoView
    {
        ...
        private async Task AgregarTelefono()
        {
            ...
            if (decimal.TryParse(Console.ReadLine(), out decimal precio))
            {
                ...
                {
                    var resultTelefono = await _controller.AgregarTelefonoService(nombre, precio, foto);

                    if (resultTelefono == "Teléfono insertado exitosamente.")
                    {
        ...
        private async Task EliminarTelefono()
        {
            ...
            if (int.TryParse(Console.ReadLine(), out int id))
            {
                ...
                if (result == "Teléfono eliminado exitosamente.")
                {
            ...
            if (int.TryParse(Console.ReadLine(), out int codTel))
            {
                ...
                if (decimal.TryParse(Console.ReadLine(), out decimal precio))
                {
                    ...
                    if (!string.IsNullOrEmpty(foto))
                    {
                        ...
                        if (result == "Teléfono actualizado exitosamente.")
                        {
